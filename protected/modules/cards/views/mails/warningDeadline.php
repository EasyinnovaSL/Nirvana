                                            ...
                                            <table border="0" cellspacing="0" cellpadding="0" align="left" >
                                                ...
                                                <tr>
                                                    <td  style="font-size: 14px; line-height: 22px; font-family:Open Sans,Arial,Tahoma, Helvetica, sans-serif; color:#777777; font-weight:300; text-align:left; ">
                                                        ...
                                                        <br><br>
                                                        <?php echo Yii::t('UserModule.views_mails_RecoverPassword', 'Your card {card_title}', array('{card_title}' => Html::encode($card->title))); ?>
                                                        <br>
                                                        <?php echo Yii::t('UserModule.views_mails_RecoverPassword', "will expired tomorrow"); ?>
                                                        <br>
