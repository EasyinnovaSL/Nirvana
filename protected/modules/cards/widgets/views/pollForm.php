...
?>
<?php echo Html::textArea("question", '', array('id' => 'contentForm_question', 'class' => 'form-control autosize contentForm',
    'rows' => '1', "tabindex" => "1", 'placeholder' => Yii::t('PollsModule.widgets_views_pollForm', "Ask something..."))); ?>
...
<div class="contentForm_options">
    ...
    <?php echo Html::hiddenInput("card_id", Yii::$app->request->get('card_id')); ?>
