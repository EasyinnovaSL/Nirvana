...
<div class="modal-dialog modal-dialog-small animated fadeIn">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel"><strong>Innovation Advisor</strong> <?php echo Yii::t("LoginUsersModule.join_the_network", "Join the network")?></h4>
        </div>
                    ...
                    <div class="tab-pane <?php echo (isset($_POST['Invite'])) ? "active" : ""; ?>"
                        ...
                        echo \humhub\widgets\AjaxButton::widget([
                            ...
                            'ajaxOptions' => [
                                ...
                                'beforeSend' => new yii\web\JsExpression('function(){ setModalLoader(); }'),
                                'success' => 'function(html){ $("#globalModal").html(html); }',
                                'url' => Url::to(['/loginUsers/auth/login','userType' => INNOVATION_ADVISOR_GROUP_ID]),
                            ],
                            'htmlOptions' => [
