    ...
    <div class="modal-content">
        ...
        <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">
                <?php echo Yii::t('CompaniesModule.views_create_create', '<strong>Create</strong> new partner search room'); ?>
            </h4>
        </div>
        <div class="modal-body">
            ...
            <?php echo $form->field($model, 'description')->textarea(['placeholder' => Yii::t('SpaceModule.views_create_create', 'Description'), 'rows' => '3']); ?>
                  ...
                  foreach ($types as $clave => $valor){
                      if(explode(" ",$valor)[0]=="PSR"){
                          $result[$clave] = $valor;
                      }
                  }
                  echo $form->field($model, 'space_type_id')->dropdownList($result); ?>

            <a data-toggle="collapse" id="access-settings-link" href="#collapse-access-settings"
               style="font-size: 11px;display: none;"><i
        ...
        <div class=" modal-footer">
            ...
            echo \humhub\widgets\AjaxButton::widget([
                ...
                'ajaxOptions' => [
                    ...
                    'url' => Url::to(['/companies/create-space/create']),
                ],
                'htmlOptions' => [
